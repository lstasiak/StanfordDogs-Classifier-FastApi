...
from src.app.models import ImageInDB
...
class TestPerformPredictions:
    @patch("src.app.routes.make_predictions.delay", autospec=True)
    @pytest.mark.asyncio
    ...
    @patch("src.app.routes.make_predictions.delay")
    @pytest.mark.asyncio
...
class TestViewPredictionResult:
    @patch("src.app.routes.view_prediction")
    @pytest.mark.asyncio
