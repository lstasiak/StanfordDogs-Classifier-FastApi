...
from backend.app.app.models.links_model import LinkGroupUser
# from backend.app.app.models.image_media_model import ImageMedia
...
class User(BaseUUIDModel, UserBase, table=True):
    ...
    images: list["Image"] = Relationship(back_populates="owner", sa_relationship_kwargs={"lazy": "selectin"})
